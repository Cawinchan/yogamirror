...
#             print(ordinal_score[0])
      ...
      #          highscore += (5 - highscore % 5)
        cv2.putText(screen_out, '  ' + ordinal_score[0], (10, 100), font, 2, (255, 15, 30), 4, cv2.LINE_AA)
        if ordinal_score[0]:
             cv2.putText(screen_out, '                   Score: ' + str(highscore), (10,100), font, 2,(255,15,30),4,cv2.LINE_AA)
